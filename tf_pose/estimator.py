...
class Human:
    ...
    '''
    __slot__ = ('body_parts', 'pairs', 'uidx_list', 'score')
    ...
    def get_upper_body_box(self, img_w, img_h):
        ...
        parts = [part for idx, part in self.body_parts.items() if part.score > _THRESHOLD_PART_CONFIDENCE]
        part_coords = [(img_w * part.x, img_h * part.y) for part in parts if part.part_idx in [0, 1, 2, 5, 8, 11, 14, 15, 16, 17]]
